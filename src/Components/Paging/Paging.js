...
const Paging = props => {
  ...
  let { parsedQS } = props;
  let itemsPerPage = parseInt(parsedQS.itemsPerPage,10) || 10;
  let page = parseInt(parsedQS.page,10) || 1;
  ...
  return (
    ...
    >
      ...
      <Typography variant="body1">Сторінка {page} з {totalPages}</Typography>
      <IconButton
        size="small"
        color="primary"
