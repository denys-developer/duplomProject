      ...
      <div>
        <div style={{ padding: 10, display: "flex", alignItems: "center" }}>
          <div style={{ flex: 1, fontSize: 24 }}>
            <div>{category ? category : "Популярні продукти"}</div>
            {subtitle}
          </div>
          ...
          >
            <MenuItem value={"lh"}>Сортування по ціні: від меншої до більшої</MenuItem>
            <MenuItem value={"hl"}>Сортування по ціні: від більшої до меншої</MenuItem>
          </Select>
        </div>
